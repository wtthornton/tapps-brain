...
class TestExceptionClasses:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (BrainDegradedError, ErrorCode.BRAIN_DEGRADED, 503, -32001, RetryPolicy.RETRY_SAFE),
            (
                BrainRateLimitedError,
                ErrorCode.BRAIN_RATE_LIMITED,
                429,
                -32029,
            ...
            (InvalidRequestError, ErrorCode.INVALID_REQUEST, 400, -32600, RetryPolicy.RETRY_NEVER),
            (
                IdempotencyConflictError,
            ...
            (NotFoundError, ErrorCode.NOT_FOUND, 404, -32004, RetryPolicy.RETRY_NEVER),
            (InternalError, ErrorCode.INTERNAL_ERROR, 500, -32500, RetryPolicy.RETRY_SAFE_ONCE),
        ],
    )
