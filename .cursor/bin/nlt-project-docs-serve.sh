...
echo "[TappsMCP] Launching MCP server: /home/wtthornton/.local/bin/docsmcp serve --profile nlt-project-docs" >&2
_blue_green="${HOME}/.tapps-mcp/current/bin/docsmcp"
if [[ -x "$_blue_green" ]]; then
  echo "[TappsMCP] Using blue/green release: $_blue_green" >&2
  exec "$_blue_green" serve --profile nlt-project-docs "$@"
fi
exec /home/wtthornton/.local/bin/docsmcp serve --profile nlt-project-docs "$@"
