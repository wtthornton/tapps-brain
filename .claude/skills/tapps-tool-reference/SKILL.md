...
---
<!-- BEGIN: tapps-skill tapps-tool-reference v3.12.83 -->
...
<!-- flagged: 7 heading(s) duplicate the managed block above verbatim (## Essential tools (always-on workflow), ## Scoring & quality, ## Documentation & experts, ## Project & memory, ## Validation & analysis, ## Pipeline & init, ## Planning, metrics & audit); 100% of this region's lines duplicate the managed block above — review and trim -->
