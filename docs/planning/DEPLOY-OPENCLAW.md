...
(counts: [`docs/generated/mcp-tools-manifest.json`](../generated/mcp-tools-manifest.json); legacy narrative cited **54** tools / **7** resources as of v1.3.1). The ClawHub skill provides discoverability, auto-configuration, and a polished install experience for the OpenClaw community.
