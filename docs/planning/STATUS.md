...
**Last updated:** 2026-08-06 — **v3.31.2**. Delivery via [Linear project](https://linear.app/tappscodingagents/project/tapps-brain-e5604347c7db) only.

**Package version (`pyproject.toml`):** **3.31.2**
