...
| EPIC-042 … EPIC-051 | Feature / technology improvement program | in_progress (050 partial; 042 story grid done; 044 stories mostly shipped) | **EPIC-042** — **042.1**–**042.8** done (**042.6** rerank observability: logs + `injection_telemetry` `rerank_*`). **EPIC-044** — **044.1**/**044.2**/**044.4**/**044.5**/**044.6**/**044.7** done (**044.4** includes merge undo; **044.7** includes `max_entries_per_group`); **044.3** core shipped (NLI backlog). **EPIC-050** — **050.2**/**050.3** done + WAL checkpoint ops note (`sqlite-database-locked.md`, `openclaw-runbook.md`); **050.1** doc done, async wrapper optional. Index: `epics/EPIC-042-feature-tech-index.md` |
...
1. **EPIC-044** — backlog: **044.3** NLI/async research; **044.1**–**044.7** shipped including **044.4** merge **undo** + threshold sweep and **044.7** per-group caps.
