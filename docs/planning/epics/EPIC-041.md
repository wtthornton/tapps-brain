...
- [x] **#52** — Hive `group:<name>` semantics (membership, propagation, recall union); shipped on `main` — GitHub **#52** checklist reconciled and **closed** 2026-04-02.
...
**Status:** done on `main` (2026-03-31); GitHub **#52** **closed** 2026-04-02 (checklist aligned with delivery).
...
1. **041.1** / **041.2** / **041.3** / **041.4** — shipped on `main`; GitHub **#51**–**#64** closed (**#52** checklist + close 2026-04-02).
