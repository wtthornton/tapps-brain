...
to 0.95 (or `aggressiveness: low` globally for 0.75). At 0.95 only near-verbatim
restatements supersede. Two distinct dossiers on a shared theme will coexist. This works
against deployed 3.28.3 with no code change.
